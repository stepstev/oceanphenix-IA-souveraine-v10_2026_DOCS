...
graph TB
    ...
    classDef tierPresentation fill:#4CAF50,stroke:#2E7D32,stroke-width:4px,color:#fff,font-size:20px
    classDef tierApp fill:#2196F3,stroke:#1565C0,stroke-width:4px,color:#fff,font-size:20px
    classDef tierData fill:#FF9800,stroke:#E65100,stroke-width:4px,color:#fff,font-size:20px
    classDef tierAnalytics fill:#9C27B0,stroke:#6A1B9A,stroke-width:4px,color:#fff,font-size:20px
    classDef tierBi fill:#E91E63,stroke:#AD1457,stroke-width:4px,color:#fff,font-size:20px
    classDef storage fill:#00BCD4,stroke:#00838F,stroke-width:3px,color:#fff,font-size:20px
    classDef vectordb fill:#9C27B0,stroke:#6A1B9A,stroke-width:3px,color:#fff,font-size:20px

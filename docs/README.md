...
> Guide complet pour installation, configuration et utilisation
...
### 🚀 Getting Started
1. **[INSTALL_LOCAL.md](INSTALL_LOCAL.md)** - Installation locale complète (30 min) ⭐ **RECOMMANDÉ pour dev/test**
2. **[INSTALL_HETZNER.md](INSTALL_HETZNER.md)** - Déploiement production Hetzner (1h)
3. **[01-GUIDE_SIMPLE.md](01-GUIDE_SIMPLE.md)** - Frontend O2Switch + Backend Hetzner (20 min)
